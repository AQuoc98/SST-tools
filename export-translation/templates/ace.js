...
const TRANSLATION_COL_END = 10; // Column K
...
export async function exportACE(file, destinationHandle) {
  ...
  if (ignoredHeaders.length > 0) {
    warnings.push(
      `Ignored header columns L-N: ${ignoredHeaders
  ...
  return {
    success: true,
    message: "Export completed successfully (ACE Template)!",
